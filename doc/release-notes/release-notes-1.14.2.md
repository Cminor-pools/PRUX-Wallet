Prux Core version 1.14.2 is now available from:

  <https://github.com/BITRY/PRUX-Wallet/releases/tag/v1.14.2/>
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * @Prux on Twitter for high priority announcements
  * @prux\_devs on Twitter for updates on development work
...
Prux Core introduces pruning the blockchain in 1.14. Pruning
...
When Prux Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Prux-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Prux Core. This was added in conjunction with
