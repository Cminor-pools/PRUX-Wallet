...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 PRUX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 prux in block rewards plus fees, but
        ...
        # Send 100000 PRUX with subtract fee from amount
