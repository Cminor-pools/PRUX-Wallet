...
void RPCConsole::clear(bool clearHistory)
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        QString(
                "table { }"
                "td.time { font-family: roboto Lt, sans-recif; font-size: 12px; color: #808080; padding-top: 3px; } "
                "td.message { font-family: roboto, sans-recif; font-weight: normal; font-size: 13px; color: #2A2A2A; white-space:pre-wrap; } "
                "td.cmd-request { color: #808080; font-size: 12px; font-family: roboto Lt, sans-recif; } "
                "td.cmd-error { color: #FF7538; font-family: roboto Lt, sans-recif; font-size: 12px; } "
                ".secwarning { color: #FF7538; font-family: roboto Lt, sans-recif; font-size: 12px; }"
                "b { color: #FF8F20; font-family: roboto, sans-recif; font-size: 13px; } "
