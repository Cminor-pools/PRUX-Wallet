...
const char * const BITCOIN_CONF_FILENAME = "prux.conf";
const char * const BITCOIN_PID_FILENAME = "pruxd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Prux";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Prux";
#else
    // Unix
    return pathRet / ".prux";
#endif
