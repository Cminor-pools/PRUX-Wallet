...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s prux-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  prux-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded prux transaction") + "\n" +
              "  prux-tx [options] -create [commands]   " + _("Create hex-encoded prux transaction") + "\n" +
              "\n";
